...
public class AdjacencyListGraph<E1, E2> implements Graph<E1, E2> {
	 ...
	 */
	private class AdjacencyListVertex implements Vertex<E1> {
		private E1 element; // elementet indeholdt i knuden
		private List<AdjacencyListEdge> list;
		 ...
		 */
		public AdjacencyListVertex(E1 e) {
			element = e;
			list = new ArrayList<>();
		}
		...
		/**
		 * Tilfoejer en kant til listen over kanter på knuden
		 * @param e
		 */
		public void addEdge(Edge<E2> e) {
			list.add((AdjacencyListEdge) e);
	 ...
	 */
	private class AdjacencyListEdge implements Edge<E2> {
		 ...
		 */
		public AdjacencyListEdge(E2 e, Vertex<E1> v1, Vertex<E1> v2) {
			element = e;
			endPoint1 = v1;
			endPoint2 = v2;
		}
	...
	public int degree(Vertex<E1> v) {
		return ((AdjacencyListVertex) v).getNumIncidentEdges();
	}
	...
	public Vertex<E1> opposite(Vertex<E1> v, Edge<E2> e) {
		Vertex<E1> v1 = ((AdjacencyListEdge) e).endPoints().get(0);
		Vertex<E1> v2 = ((AdjacencyListEdge) e).endPoints().get(1);
		if (v == v1)
			return v2;
		else
			return v1;
