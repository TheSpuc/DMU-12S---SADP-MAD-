...
public abstract class FletteTemplate<E extends Comparable<E>> {
	...
	// Template method med fletteskabelon.
	// Pre: s1 og s2 er sorteret i ikke aftagende orden. g er en tom sekvens
	//
	// Post: g sorteret sekvens indeholdendede resultatet af fletningen af s1 og
	// s2
	...
	// Primitive metoder der kaldes fra Tempplate Method og overskrives i
	// subklasser
